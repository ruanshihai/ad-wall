    ...
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        ...
        <div class="sidebar-left">
          @if(Auth::user()->type == 0)
            <a class="item {{ strpos(URL::current(), 'admin/ad/waiting-list') !== false ? 'item-current' : '' }}" href="{{ url('admin/ad/waiting-list') }}">待审核列表</a>
            <a class="item {{ strpos(URL::current(), 'admin/ad/rejected-list') !== false ? 'item-current' : '' }}" href="{{ url('admin/ad/rejected-list') }}">已回绝列表</a>
            <a class="item {{ strpos(URL::current(), 'admin/ad/passed-list') !== false ? 'item-current' : '' }}" href="{{ url('admin/ad/passed-list') }}">已通过列表</a>
